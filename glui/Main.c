...
main(int argc, char* argv[])
{
	...
	Option opt[] = { { .long_name = "path",
			 ...
			 { .long_name = "font_rotation_factor",
			  .description = "Rotate on-screen text in tune with music",
			  .type = OPT_FLOAT,
			  .has_arg = true,
			  .in_cfg_file = true,
			  .initial.f = 0.f,
			 ...
			 { .long_name = "bg_flash_factor",
	                   .description = "Flash background text in tune with music",
	                   .type = OPT_FLOAT,
	                   .has_arg = true,
	                   .in_cfg_file = true,
	                   .initial.f = 0.f,
	       ...
	       .description = "Circular vis expands with energy (0-100)",
	       .type = OPT_FLOAT,
	       .has_arg = true,
	       .in_cfg_file = true,
	       .initial.f = 8.f,
	       ...
	       .description = "Circular vis rotation reactivity (0-100)",
	       .type = OPT_FLOAT,
	       .has_arg = true,
	       .in_cfg_file = true,
	       .initial.f = 5.f,
